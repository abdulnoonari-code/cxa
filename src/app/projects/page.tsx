...
export default async function ProjectsPage({
  ...
  // The list is now the projects this person has access to, rather than every
  // project on the account. Nothing else about this page changed: it is still
  // where a project is opened, created and deleted, and it is still reached
  // from the same place in the rail.
  ...
  return (
    <>
      ...
      <p className="page-subtitle">
        The sites you have access to. Open one and the whole application — dashboard, project details, setup,
        equipment, checks, documents, punch list, milestones — shows that project only.
      </p>
      <p className="text-secondary" style={{ fontSize: 12.5, margin: '-8px 0 18px' }}>
